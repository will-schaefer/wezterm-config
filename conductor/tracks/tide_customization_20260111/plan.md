# Plan: Customize Tide Prompt Icons & Colors (Left Prompt)

## Phase 1: Audit & Discovery
- [x] Task: List available Tide variables for Git status icons, colors, and the OS icon [00225eb]
- [x] Task: Identify and list additional "hidden" or disabled Git/GitHub context items available in Tide [00225eb]
