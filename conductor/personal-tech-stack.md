# Personal Tech Stack Inventory

This document serves as the central source of truth for my entire terminal and development environment.

## Core Applications
*Primary tools that define the workspace.*
